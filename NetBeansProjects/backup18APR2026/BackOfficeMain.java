...
public class BackOfficeMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton8.setText("P-D");
        jButton8.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PtoDActionPerformed(evt);
            }
        });

        jButton9.setText("P-B");
        jButton9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PtoBActionPerformed(evt);
            }
        });

        jButton10.setText("D-B");
        ...
        jButton13.setText("B-FP");
        jButton13.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtoPaidFullActionPerformed(evt);
            }
        });
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        // List OPEN "GRP" GROUPS
        try {
                String mycmd="cmd /c start dir /b %DROPBOX_HOME%\\001_Safari\\*GRP*";
    ...
    private void BtoPaidFullActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtoPaidFullActionPerformed
        // TODO add your handling code here:
        // BALANCE to PAID FULL
        try {
            String custname=jTextField1.getText();
            String newcust="cmd /c start python BtoPaidFull.py " + custname;
            Runtime rn=Runtime.getRuntime();
    ...
    private void DtoBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DtoBActionPerformed
        ...
        try {
            String custname=jTextField1.getText();
            String newcust="cmd /c start python DtoB.py " + custname;
            Runtime rn=Runtime.getRuntime();
            Process pr=rn.exec(newcust);
        }   catch(IOException ioException) {
            System.out.println(ioException.getMessage() );
    ...
    private void PtoBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PtoBActionPerformed
        ...
        try {
            String custname=jTextField1.getText();
            String newcust="cmd /c start python PtoB.py " + custname;
            Runtime rn=Runtime.getRuntime();
            Process pr=rn.exec(newcust);
        }   catch(IOException ioException) {
            System.out.println(ioException.getMessage() );
    ...
    private void PtoDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PtoDActionPerformed
        ...
        try {
            String custname=jTextField1.getText();
            String newcust="cmd /c start python PtoD.py " + custname;
            Runtime rn=Runtime.getRuntime();
            Process pr=rn.exec(newcust);
        }   catch(IOException ioException) {
            System.out.println(ioException.getMessage() );
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        try {
            ...
            String newname=jTextField7.getText();
            String mycmd="cmd /c start rename \"%DROPBOX_HOME%\\\"" + foldername + "\\" + currentname + " " + newname;
            Runtime rn=Runtime.getRuntime();
            Process pr=rn.exec(mycmd);
        }   catch(IOException ioException) {
            System.out.println(ioException.getMessage() );
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        {
            //Terminates program and don't confirm safari as there is incorrect middle date
            System.out.println("Incorrect Middle Date, the correct format is DDMMM, for example 10JAN. We can't confirm the safari, check the dates please");
        ...
        {
            //Terminates program and don't confirm safari as there is no end date
            System.out.println("Missing/Incorrect START, MIDDLE or END Date, we can't confirm the safari, check the dates please");
        ...
        {
            //Terminates program and don't confirm safari as there is no end date
            System.out.println("Missing/Incorrect START Date, the correct format is DDMMM, for example 10JAN. We can't confirm the safari, check the dates please");
        ...
        {
            //Terminates program and don't confirm safari as there is no end date
            System.out.println("Missing/Incorrect END Date, the correct format is DDMMMYYYY, for example 10JAN2025. We can't confirm the safari, check the dates please");
        ...
        if (enddate.matches("(?i).*JAN.*"))
        {
            endmonth="01";
        }
        if (enddate.matches("(?i).*FEB.*"))
        {
            endmonth="02";
        }
        if (enddate.matches("(?i).*MAR.*"))
        {
            endmonth="03";
        }
        if (enddate.matches("(?i).*APR.*"))
        {
            endmonth="04";
        }
        if (enddate.matches("(?i).*MAY.*"))
        {
            endmonth="05";
        }
        if (enddate.matches("(?i).*JUN.*"))
        {
            endmonth="06";
        }
        if (enddate.matches("(?i).*JUL.*"))
        {
            endmonth="07";
        }
        if (enddate.matches("(?i).*AUG.*"))
        {
            endmonth="08";
        }
        if (enddate.matches("(?i).*SEP.*"))
        {
            endmonth="09";
        }
        if (enddate.matches("(?i).*OCT.*"))
        {
            endmonth="10";
        }
        if (enddate.matches("(?i).*NOV.*"))
        {
            endmonth="11";
        }
        if (enddate.matches("(?i).*DEC.*"))
        {
            endmonth="12";
        }
        ...
        {
            //Terminates program and don't confirm safari as there is incorrect middle date
                        JOptionPane.showMessageDialog(null, "HERE - Incorrect End Date Month, the correct format is MMM, for example JAN. We can't confirm the safari, check the dates and try again", "DATE ERROR", JOptionPane.ERROR_MESSAGE);
            //System.exit(0);
            return;
        }  

        // confirmedfolder contains now the new folder name
        // move the folder to the new name
        try {
            String mycmd="cmd /c start /D \"%DROPBOX_HOME%\\%REQ_YEAR%\\\" rename " +custname+" "+confirmedfolder;
            Runtime rn=Runtime.getRuntime();
            Process pr=rn.exec(mycmd);
        }   catch(IOException ioException) {
            System.out.println(ioException.getMessage() );
        ...
        // move the safari into 001_Safari
        try {
            String newcust="cmd /c start /D \"%DROPBOX_HOME%\\SavannahScripts\\\" \" \" cfolders.bat " + confirmedfolder;
            Runtime rn=Runtime.getRuntime();
            Process pr=rn.exec(newcust);
        }   catch(IOException ioException) {
            System.out.println(ioException.getMessage() );
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        // TODO add your handling code here:     
        try {
            String mytext=jTextField11.getText();
            String mycmd="cmd /c start dir /S /b \"%DROPBOX_HOME%\\001_Safari\\\"*"+ mytext +"*";
            Runtime rn=Runtime.getRuntime();
            Process pr=rn.exec(mycmd);
        }   catch(IOException ioException) {
            System.out.println(ioException.getMessage() );
    ...
    private void showResultsPopup(String title, java.util.List<String> results) {
        if (results.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(
                this, "Nessun risultato trovato.", title,
        ...
        javax.swing.JLabel hint = new javax.swing.JLabel(
            "  Doppio click per selezionare e popolare Customer File");
        hint.setFont(hint.getFont().deriveFont(java.awt.Font.ITALIC, 11f));
